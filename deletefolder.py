...
if __name__ == "__main__":
    economist_espresso_dir = "Economist_Espresso"
    latest_date_folder = get_latest_date_folder(economist_espresso_dir)
    if latest_date_folder:
        print(f"Latest date folder: {latest_date_folder}")
        remove_old_folders(economist_espresso_dir, latest_date_folder)
    else:
        print("No folders found in Economist_Espresso directory.")
